...
3. **Geração de Recursos Visuais (Imagens e Infográficos):**
   ...
   - **MUITO IMPORTANTE:** Sempre copie/mova fisicamente as imagens geradas pela IA (que nascem na pasta temporária do `.gemini/antigravity/brain/`) para a pasta oficial do pacote (`/Users/viniciusdias/Developer/dm/DMAI/[NomeDoPacote]/`) e certifique-se de que os arquivos Markdown apontem estritamente para esses caminhos finais organizados.
